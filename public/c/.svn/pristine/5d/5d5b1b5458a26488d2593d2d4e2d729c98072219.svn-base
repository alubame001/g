...
// 服务器地址
window.walletUrl = "http://192.168.31.157:9000/mobile/";
window.serverUrl = "http://192.168.31.157:8092/mobile/";
window.jsonUrl = "http://192.168.31.157:8092/json/";
window.uploadUrl = "http://7xrbfv.com1.z0.glb.clouddn.com/";
...
// APP默认参数 END
// 用户偏好设置的Key
window.userKey = "xadiu2229E222eaaaaa1";
window.coinKey= "kkjddlddd";
window.randomKey ="kkhgdddfj";
window.address= "kkdddhfg的dj";
window.coinList= "kdkddkgdj";

window.gameId="";
//window.coinBalance= "kddkgkd";
// 继承拓展对象
...
function _fixStatusBar2(headerid, callback) {
	var header = $api.byId(headerid);
	var systemType = api.systemType;
	var systemVersion = parseFloat(api.systemVersion);
	if (systemType == "ios" || (systemType == "android" && systemVersion >= 4.4)) {
