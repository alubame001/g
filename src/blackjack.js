...
function Blackjack (hex,bet,step) {
var GET_FIRST_TWO_CARD = 0 
this.step = step;
var multiplier=[        //MULTIPLIER FOR EACH BET
  ...
  if (hex){
    ...
    this.result.hex = hex  
    this.result.cards= this.result.cards.slice(0,3)
    this.result.cards.push("XX")

    switch (step) {
      case GET_FIRST_TWO_CARD:
...
Blackjack.prototype.build= function (hex) {
